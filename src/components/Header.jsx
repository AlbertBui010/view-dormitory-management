...
const Header = () => {
  ...
  return (
    <div className="">
      <div className="w-full bg-zinc-900 z-40 shadow-md fixed">
        {/* TOP HEADER - Ẩn khi scroll */}
        <div
          className={`w-[80%] mx-auto flex items-center justify-between transition-all duration-300 overflow-hidden ${
            isScrolled ? "h-0 opacity-0" : "h-[150px] opacity-100"
          }`}
        >
          <img
            src={logo}
            alt="Logo"
            className="w-[125px] h-[125px] transition-all duration-300"
          />
